...
router.get('/:flag/isLoggedInFlag', auth.isAuthenticated(), controller.loggedInFlag);
router.get('/getTeamActions', auth.isAuthenticated(), controller.getTeamActions);
router.get('/getTeamMembers', auth.isAuthenticated(), controller.getTeamMembers);
...
router.put('/:round/:marketBusinessName/globalOfferHistory', auth.isAuthenticated(), controller.globalOfferHistory);
...
router.get('/:id/getAllOffersMade', auth.isAuthenticated(), controller.getAllOffersMade);
router.get('/:id/getAllWonCustomers', auth.isAuthenticated(), controller.getAllWonCustomers);
router.put('/:id/getCurrentRoundStrategyBand', auth.isAuthenticated(), controller.getCurrentRoundStrategyBand);
router.put('/:id/getCurrentRoundGlobalSalesDepartmentInfo', auth.isAuthenticated(), controller.getCurrentRoundGlobalSalesDepartmentInfo);
router.put('/:id/getCurrentRoundNewGlobalOffers', auth.isAuthenticated(), controller.getCurrentRoundNewGlobalOffers);
router.put('/:id/getCurrentRoundRiskStrategies', auth.isAuthenticated(), controller.getCurrentRoundRiskStrategies);
router.put('/:id/allRoundLevelInformation', auth.isAuthenticated(), controller.allRoundLevelInformation);
router.put('/:id/addToRiskStrategy', auth.isAuthenticated(), controller.addToRiskStrategy);
router.put('/:id/removeFromRiskStrategy', auth.isAuthenticated(), controller.removeFromRiskStrategy);
